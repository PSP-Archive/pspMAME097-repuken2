...
static MACHINE_DRIVER_START( simpsons )
	...
	MDRV_CPU_ADD(Z80, 3500000)	//orig 3579545 /* Reznor007 verified with schematics + PCB trace */
	/* audio CPU */
	...
	MDRV_SOUND_ADD(YM2151, 3500000) //orig 3579545
	...
	MDRV_SOUND_ADD(K053260, 3500000) /* measured on real pcb */ //orig 3579545
