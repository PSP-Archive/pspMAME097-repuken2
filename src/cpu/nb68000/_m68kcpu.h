...
//#define CPU_TYPE		   M68KI_CPU_PTR/*m68ki_cpu.*/cpu_type
#define CPU_TYPE		 CPU_TYPE_000

#define REG_DA			 M68KI_CPU_PTR/*m68ki_cpu.*/dar /* easy access to data and address regs */
#define REG_D			 M68KI_CPU_PTR/*m68ki_cpu.*/dar
#define REG_A			 (M68KI_CPU_PTR/*m68ki_cpu.*/dar+8)

#if (1==M68K_USE_PPC)
#define REG_PPC 		 M68KI_CPU_PTR/*m68ki_cpu.*/ppc
#endif //(1==M68K_USE_PPC)

#define REG_PC			 M68KI_CPU_PTR/*m68ki_cpu.*/pc
#define REG_SP_BASE 	 M68KI_CPU_PTR/*m68ki_cpu.*/sp
#define REG_USP 		 M68KI_CPU_PTR/*m68ki_cpu.*/sp[0]
#define REG_ISP 		 M68KI_CPU_PTR/*m68ki_cpu.*/sp[4]
#define REG_MSP 		 M68KI_CPU_PTR/*m68ki_cpu.*/sp[6]
#define REG_SP			 M68KI_CPU_PTR/*m68ki_cpu.*/dar[15]
//#define REG_VBR		   M68KI_CPU_PTR/*m68ki_cpu.*/vbr
//#define REG_SFC		   M68KI_CPU_PTR/*m68ki_cpu.*/sfc
//#define REG_DFC		   M68KI_CPU_PTR/*m68ki_cpu.*/dfc
//#define REG_CACR		   M68KI_CPU_PTR/*m68ki_cpu.*/cacr
//#define REG_CAAR		   M68KI_CPU_PTR/*m68ki_cpu.*/caar

#define USE_TRACE 0

#if (1==M68K_EMULATE_TRACE)
#define FLAG_T1 		 M68KI_CPU_PTR/*m68ki_cpu.*/t1_flag
#define FLAG_T0 		 M68KI_CPU_PTR/*m68ki_cpu.*/t0_flag
#endif //(1==M68K_EMULATE_TRACE)

#define FLAG_S			 M68KI_CPU_PTR/*m68ki_cpu.*/s_flag
#define FLAG_M			 M68KI_CPU_PTR/*m68ki_cpu.*/m_flag
#define FLAG_X			 M68KI_CPU_PTR/*m68ki_cpu.*/x_flag
#define FLAG_N			 M68KI_CPU_PTR/*m68ki_cpu.*/n_flag
#define FLAG_Z			 M68KI_CPU_PTR/*m68ki_cpu.*/not_z_flag
#define FLAG_V			 M68KI_CPU_PTR/*m68ki_cpu.*/v_flag
#define FLAG_C			 M68KI_CPU_PTR/*m68ki_cpu.*/c_flag
#define FLAG_INT_MASK	 M68KI_CPU_PTR/*m68ki_cpu.*/int_mask

#if (1==USE_TEMP_TYPE)
#define src 			 M68KI_CPU_PTR/*m68ki_cpu.*/my_src
#define dst 			 M68KI_CPU_PTR/*m68ki_cpu.*/my_dst
#define ea				 M68KI_CPU_PTR/*m68ki_cpu.*/my_ea
#define res 			 M68KI_CPU_PTR/*m68ki_cpu.*/my_res
#endif // (0==USE_TEMP_TYPE)
#if (1==USE_TEMP_IR_TYPE)
#define REG_IR			 M68KI_CPU_PTR/*m68ki_cpu.*/ir
#endif // (0==USE_TEMP_IR_TYPE)
...
#define ea				 my_ea
#define res 			 my_res
#endif // (2==USE_TEMP_TYPE)
#if (2==USE_TEMP_IR_TYPE)
#define REG_IR			 my_ir
#endif // (0==USE_TEMP_IR_TYPE)

#define CPU_INT_LEVEL	 M68KI_CPU_PTR/*m68ki_cpu.*/int_level /* ASG: changed from CPU_INTS_PENDING */
//#define CPU_INT_CYCLES	 M68KI_CPU_PTR/*m68ki_cpu.*/int_cycles /* ASG */
#define MPU_STOPPED 	 M68KI_CPU_PTR/*m68ki_cpu.*/stopped
#define CPU_PREF_ADDR	 M68KI_CPU_PTR/*m68ki_cpu.*/pref_addr
#define CPU_PREF_DATA	 M68KI_CPU_PTR/*m68ki_cpu.*/pref_data
//#define CPU_ADDRESS_MASK M68KI_CPU_PTR/*m68ki_cpu.*/address_mask
//#define CPU_SR_MASK	   M68KI_CPU_PTR/*m68ki_cpu.*/sr_mask
#define MPU_INSTR_MODE	 M68KI_CPU_PTR/*m68ki_cpu.*/instr_mode
#define MPU_RUN_MODE	 M68KI_CPU_PTR/*m68ki_cpu.*/run_mode

//#define CYC_INSTRUCTION  M68KI_CPU_PTR/*m68ki_cpu.*/cyc_instruction
//#define CYC_EXCEPTION    M68KI_CPU_PTR/*m68ki_cpu.*/cyc_exception

//#define CYC_BCC_NOTAKE_B M68KI_CPU_PTR/*m68ki_cpu.*/cyc_bcc_notake_b
//#define CYC_BCC_NOTAKE_W M68KI_CPU_PTR/*m68ki_cpu.*/cyc_bcc_notake_w
//#define CYC_DBCC_F_NOEXP M68KI_CPU_PTR/*m68ki_cpu.*/cyc_dbcc_f_noexp
//#define CYC_DBCC_F_EXP   M68KI_CPU_PTR/*m68ki_cpu.*/cyc_dbcc_f_exp
//#define CYC_SCC_R_TRUE   M68KI_CPU_PTR/*m68ki_cpu.*/cyc_scc_r_true
//#define CYC_MOVEM_W	   M68KI_CPU_PTR/*m68ki_cpu.*/cyc_movem_w
//#define CYC_MOVEM_L	   M68KI_CPU_PTR/*m68ki_cpu.*/cyc_movem_l
//#define CYC_SHIFT 	   M68KI_CPU_PTR/*m68ki_cpu.*/cyc_shift
//#define CYC_RESET 	   M68KI_CPU_PTR/*m68ki_cpu.*/cyc_reset
...
/*IRQ ÇÕó·äOÇ≈ MAMEïWèÄ callback */
#define CALLBACK_INT_ACK	  M68KI_CPU_PTR/*m68ki_cpu.*/int_ack_callback

#if 0
//(m68010+)#define CALLBACK_BKPT_ACK	  M68KI_CPU_PTR/*m68ki_cpu.*/bkpt_ack_callback
#endif

#if (1==M68K_USE_SYS16_CALLBACK)
#define CALLBACK_RESET_INSTR  M68KI_CPU_PTR/*m68ki_cpu.*/reset_instr_callback
#define CALLBACK_CMPILD_INSTR M68KI_CPU_PTR/*m68ki_cpu.*/cmpild_instr_callback
#define CALLBACK_RTE_INSTR	  M68KI_CPU_PTR/*m68ki_cpu.*/rte_instr_callback
#endif // (1==M68K_USE_SYS16_CALLBACK)

#if (1==M68K_USE_CALLBACK)
#define CALLBACK_PC_CHANGED   M68KI_CPU_PTR/*m68ki_cpu.*/pc_changed_callback
#define CALLBACK_SET_FC 	  M68KI_CPU_PTR/*m68ki_cpu.*/set_fc_callback
#define CALLBACK_INSTR_HOOK   M68KI_CPU_PTR/*m68ki_cpu.*/instr_hook_callback

#else

//static int default_int_ack_callback(int int_level);
//(m68010+)static void default_bkpt_ack_callback(unsigned int data);
...
//
	...
	uint my_res;
	uint my_ea;
	#endif // (1==USE_TEMP_TYPE)
	#if (1==USE_TEMP_IR_TYPE)
	uint my_ir; 		/* Instruction Register */
	#endif // (1==USE_TEMP_IR_TYPE)
//
...
//	uint8* cyc_exception;
	/* Callbacks to host */
	int  (*int_ack_callback)(int int_line); 			/*(IRQ) Interrupt Acknowledge */
//	void (*bkpt_ack_callback)(unsigned int data);		/* (m68010+) Breakpoint Acknowledge */
#if (1==M68K_USE_SYS16_CALLBACK)
...
///*extern*/static /*sint*/signed short 			m68ki_remaining_cycles;
...
///*extern*/ static const UINT8 m68ki_exception_cycle_table000[48/*256*/];
///*extern*/ static const UINT8 m68ki_ea_idx_cycle_table[];
