 ...
 */
/*IRQ‚Í—áŠO*/
static void m68k_set_int_ack_callback(int  (*callback)(int int_level));
 ...
 */
//(m68010+)static void m68k_set_bkpt_ack_callback(void (*callback)(unsigned int data));
#endif
 ...
 * Default behavior: do nothing.
 */
static void m68k_set_reset_instr_callback(void  (*callback)(void));
 ...
 * Default behavior: do nothing.
 */
static void m68k_set_cmpild_instr_callback(void  (*callback)(unsigned int val, int reg));
 ...
 * Default behavior: do nothing.
 */
static void m68k_set_pc_changed_callback(void  (*callback)(unsigned int new_pc));
 ...
 * Default behavior: do nothing.
 */
static void m68k_set_fc_callback(void  (*callback)(unsigned int new_fc));
 ...
 * Default behavior: do nothing.
 */
static void m68k_set_instr_hook_callback(void  (*callback)(void));
