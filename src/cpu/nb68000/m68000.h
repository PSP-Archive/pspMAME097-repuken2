...
#ifndef CPU_ICOUNT_LENGTH
#define PSP_2006 1
#define CPU_ICOUNT_LENGTH 32
#define LINK_ADDRBUS_SHIFT 1
#define LINK_DATA_REGION 1
#endif
...
#ifdef _MAME_68K_INTERNAL_
	//#ifndef m68k_ICount
	//#define m68k_ICount m68ki_remaining_cycles
	//#endif
	#ifndef m68ki_remaining_cycles
	#define m68ki_remaining_cycles m68k_ICount
	//#endif
	#if (16==CPU_ICOUNT_LENGTH)
	/*extern*/static  short m68ki_remaining_cycles;//m68k_ICount;
	#else
	/*extern*/static  int m68ki_remaining_cycles;//m68k_ICount;
	#endif //(16==CPU_ICOUNT_LENGTH)
	#endif //m68ki_remaining_cycles
